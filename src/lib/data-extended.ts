...
export const AI_CHAT_MESSAGES = [
  {
    ...
    role: 'assistant',
    sender: 'ai',
    content: 'Good morning Commander. YatraFlow AI Copilot is monitoring Somnath, Dwarka, Ambaji, and Pavagadh edge feeds. Current risk index across Gujarat is NOMINAL, with a moderate surge developing at Ambaji Chachar Chowk.',
    text: 'Good morning Commander. YatraFlow AI Copilot is monitoring Somnath, Dwarka, Ambaji, and Pavagadh edge feeds. Current risk index across Gujarat is NOMINAL, with a moderate surge developing at Ambaji Chachar Chowk.',
    timestamp: '11:00 AM',
    time: '11:00 AM',
  },
  {
